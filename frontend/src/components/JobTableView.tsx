                ...
                >
                  ...
                  <td className="py-3 px-4 max-w-xs">
                    ...
                    <button
                      ...
                      className="text-[10px] font-mono text-slate-500 hover:text-slate-300 inline-flex items-center gap-1 mt-0.5 cursor-pointer"
                      title="Copy full ID"
                    >
                  ...
                  <td className="py-3 px-4 text-right whitespace-nowrap">
                    <div className="flex items-center justify-end gap-1.5">
                      {job.status === 'pending' && (
                        <>
                          <button
                            ...
                            className="px-2.5 py-1 rounded bg-blue-600 hover:bg-blue-500 text-white font-medium text-[11px] inline-flex items-center gap-1 transition cursor-pointer"
                          >
                          ...
                          <button
                            ...
                            className="px-2 py-1 rounded bg-slate-800 hover:bg-slate-750 text-amber-300 border border-amber-500/20 text-[11px] inline-flex items-center gap-1 transition cursor-pointer"
                          >
                      ...
                      {job.status === 'running' && (
                        <>
                          <button
                            ...
                            disabled={actionLoading !== null}
                            className="px-2.5 py-1 rounded bg-emerald-600 hover:bg-emerald-500 text-white font-medium text-[11px] inline-flex items-center gap-1 transition cursor-pointer"
                          >
                          ...
                          <button
                            ...
                            disabled={actionLoading !== null}
                            className="px-2.5 py-1 rounded bg-rose-600 hover:bg-rose-500 text-white font-medium text-[11px] inline-flex items-center gap-1 transition cursor-pointer"
                          >
                      ...
                      {isTerminal && (
                        <span className="text-[11px] text-slate-500 inline-flex items-center gap-1 select-none pr-1">
